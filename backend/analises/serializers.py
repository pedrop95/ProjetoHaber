...
class RegistroAnaliseSerializer(serializers.ModelSerializer):
    ...
    def update(self, instance, validated_data):
        ...
        instance.status = validated_data.get('status', instance.status) # Adicione esta linha
        instance.save()
        ...
        for detalhe_data in detalhes_data:
            ...
            if detalhe_id:
                ...
                detalhe.elemento_quimico = detalhe_data.get('elemento_quimico', detalhe.elemento_quimico)
